 ...
 *
 * @returns {object}
 */function findBisect(e,t){var n=0,r=t.length-1,i=t[n];if(i>=e)return{val:n,part:0};var a=t[r];if(a<e)return{val:r,part:0};for(;r-n>1;){var l=n+Math.round((r-n)/2),o=t[l];o>=e?(r=l,a=o):(n=l,i=o)}return{val:n,part:(e-i)/(a-i)}}
/**
 ...
 * @param str
 * @returns {number}
 */function substrCount(e,t){for(var n=-1,r=-2;-1!=r;)n++,r=t.indexOf(e,r+1);return n}
/**
 * Selects the content of the given DOM node.
 *
 * @param eNode
 */function selectText(e){if(window.getSelection){var t=window.getSelection(),n=document.createRange();n.selectNodeContents(e),t.removeAllRanges(),t.addRange(n)}}
/**
 ...
 * @constructor
 */function Animator(e,t){var n,r,i,a,l,o=0,s=0,c=0,u=0,f=200,v=null,d=function(e){null===v&&(v=e);var s=e-v;s<r?(o=c+i*(Math.cos(a*(s-r))-1),u=i*a*Math.sin(a*(r-s)),t(o),n=requestAnimationFrame(d),m&&(
/**
				 * If the position has been forced, we run the animation again.
				 */
h(l,o),m=!1,v=e)):(v=null,u=0,t(c),cancelAnimationFrame(n),m&&(m=!1))},m=!1;
/**
	 ...
	 * @param oldPosition
	 */
function h(e,t){var n;if(c=e,s=t,Math.abs(u)<1e-5)n=Math.PI,r=f;else{var l=(c-s)/u/f;
/**
			 * Instead of solving non-linear equation alpha * k = tan(k/2)
			 * we use approximation 0.5/a = 1 - (k/pi)^2
			 */n=l<0||l>.5?Math.PI*Math.sqrt(1-.5/l):.1
/**
			 ...
			 */;var o=(1-Math.cos(n))/n/Math.sin(n);r=(c-s)/o/u}a=n/r,i=(c-s)/(1-Math.cos(n))}
/**
	 * Public control method
	 *
	 * @param nextPos
	 */this.setPos=function(t){(m=null!==v)?l=t:(h(t,o=e()),n=requestAnimationFrame(d))},this.stop=function(){v=null,u=0,cancelAnimationFrame(n),m=!1}}function escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}
/**
...
/**
	 ...
	 * @returns {*}
	 */
function(e){var n=e.match(/id=["']([^"']*)["']/g);if(!n)return e;for(var r,i,a,l=n.length;l--;)r=(a=n[l]).match(/id=["']([^"']*)["']/)[1],i="s"+t+r,e=e.replaceAll(a,'id="'+i+'"').replaceAll("#"+r,"#"+i);return t++,e}(r)).match(/postMessage\((?:&quot;|")([\d\|\.\-eE]*)(?:&quot;|")/);if(l)var o=l&&l[1]?l[1].split("|").shift():0;else o=null;a.callback(n,r,o,i),a.svg=r,a.baseline=o,a.request=null,a.callback=null}};
/**
	 * External API
	 *
	 * @param url
	 * @returns {null}
	 */this.getImageDataFromUrl=function(t){var n=e[t];return n||null}}
/**
 *
 * @param preloader
 ...
 * @constructor
 */function ImageLoader(e,t,n){var r=[],i=[],a={},l=0,o=null,s=null,c=null,u=1;this.loaderid=n,
/**
	 * Start parsing process.
	 */
this.reset=function(){r=[],l=0,u=1};
/**
	 * Insert SVG images.
	 *
	 * @param url
	 ...
	 * @param baselineShift
	 */
var f=function(e,t,n,r){var i,l=a[e];if(l&&(i=l.length))for(;i--;){var f=l[i];v(f,t,n,f===s?"fade-in":"replace",r)&&(u+=1),f===s&&(clearTimeout(o),s=null,c=null)}};
/**
	 ...
	 */function v(e,t,n,r,i){var a=i+"s2tex_"+e,l=document.getElementById(a),s=l.parentNode,c="fade-out"==r?"0.5":"1",f='<svg class="svg-preview" id="'+a+'" ',v=!1;if("center"===s.style.textAlign&&(s.id.match(/eq\:.*$/)&&1==s.childElementCount)){v=!0;var d=document.createElement("em");d.innerHTML="("+u+")";var m=document.createElement("span");s.insertBefore(m,l),s.appendChild(d)}var h=t.match(/ height="[\.\d]+" /g)[0].trim().split("=")[1].replace(/"/g,"");f+=null===n?'width="13px" height="13px" ':'style="--latex_align: '+-n+"pt; --latex_height: "+h+"px; vertical-align:"+-n+'pt; opacity: 1" ';var p=document.createElement("div");p.innerHTML=t.replace("<svg ",f);var g=p.firstElementChild;return p.removeChild(g),s.insertBefore(g,l),s.removeChild(l),"1"!=c&&(o=setTimeout(function(){document.getElementById(a).style.opacity=c},0)),v}
/**
	 * Generate the picture HTML code while parsing and store the state.
	 *
	 * @param formula
	 * @returns {string}
	 */this.getHtmlStub=function(e){r[l]=t+"//mur2.co.uk:8005/svg/"+encodeURIComponent(e);var n='<span id="'+this.loaderid+"s2tex_"+l+'"></span>';return l++,n},
/**
...
/**
	 ...
	 */
function(){if(l==i.length){for(var e,t=0,n=l;n--;)r[n]!=i[n]&&(t++,e=n);if(1==t){if(null===s)return s=e,void(c=i[e]);if(s===e)return}}s=null,c=null}(),function(){a={};for(var e=l;e--;){var t=r[e];void 0===a[t]?a[t]=[e]:(a[t].push(e),a[t].sort(function(e,t){return t-e}))}}();for(var t=0;t<l;t++)e.onLoad(r[t],f,this.loaderid);if(null!==s){var n=e.getImageDataFromUrl(c);if(null!==n&&null===n.callback)v(s,n.svg,n.baseline,"fade-out",this.loaderid)&&(u+=1)}i=r.slice(0)}}
/**
 * Access to the map between blocks in sync scroll.
 *
 * @param mapBuilder
 * @constructor
 */function ScrollMap(e){var t=null;this.reset=function(){t=[null,null]},this.getPosition=function(n,r,i){var a=n.offsetHeight,l=n.scrollTop;if(0==l)return 0;null===t[r]&&(t=e());var o=t[r].length-1;if(t[r][o]<=l+a)return t[i][o]-a;var s=a/2,c=findBisect(l+s,t[r]),u=parseFloat(t[i][c.val]*(1-c.part));return t[i][c.val+1]&&(u+=parseFloat(t[i][c.val+1]*c.part)),u-s}}
/**
