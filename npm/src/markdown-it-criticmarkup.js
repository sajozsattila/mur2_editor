    ...
    return (function() {
        ...
        1: [function(require, module, exports) {
            ...
            module.exports = function critcmarkup_plugin(md) {
                md.inline.ruler.before('strikethrough', 'critic_markup', (state, silent) => {
                    const src = state.src,
                        pos = state.pos;
                    ...
                    if (src[pos] === '{' && (src[pos + 1] === '-' && src[pos + 2] === '-' || src[pos + 1] === '+' && src[pos + 2] === '+' || src[pos + 1] === '~' && src[pos + 2] === '~' || src[pos + 1] === '=' && src[pos + 2] === '=' || src[pos + 1] === '>' && src[pos + 2] === '>')) {
                        ...
                        if (content && !silent) {
                            const token = state.push('critic_markup');
                ...
                md.renderer.rules.critic_markup = function(tokens, idx) {
